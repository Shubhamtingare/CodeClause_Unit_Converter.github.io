 ...
 function getElementById(elements)
{
...
function uc1(){document.getElementById('p1').style.display='block'}
function uc2(){document.getElementById('p2').style.display='block'}
function uc3(){document.getElementById('p3').style.display='block'}
function uc4(){document.getElementById('p4').style.display='block'}
function uc5(){document.getElementById('p5').style.display='block'}
function uc6(){document.getElementById('p6').style.display='block'}
function len()
{
...
if(document.getElementById('lip').value==null||document.getElementById('lip').value.length==0)
...
if(document.getElementById('aip').value==null||document.getElementById('aip').value.length==0)
...
if(document.getElementById('sip').value==null||document.getElementById('sip').value.length==0)
...
if(document.getElementById('wip').value==null||document.getElementById('wip').value.length==0)
...
if(document.getElementById('vip').value==null||document.getElementById('vip').value.length==0)
...
if(document.getElementById('tip').value==null||document.getElementById('tip').value.length==0)
